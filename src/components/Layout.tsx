...
export default function Layout({ children }: LayoutProps) {
  ...
  const { state: authState, showAuthModal, logout } = useAuth();
          ...
          <div className="flex h-20 items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              <Button 
                variant="ghost" 
                size="sm" 
                className="hover:bg-rose-50 hover:text-rose-600 transition-colors relative"
              ...
              >
                ...
                {cartState.itemCount > 0 && (
                  <span className="absolute -top-1 -right-1 w-5 h-5 bg-amber-400 text-white text-xs rounded-full flex items-center justify-center">
                    {cartState.itemCount}
                  </span>
                )}
              </Button>
