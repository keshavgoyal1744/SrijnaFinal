      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {features.map((feature, index) => (
            <Card
              key={index}
              className="text-center border-luxury-rose hover:shadow-elegant transition-all duration-300 hover:scale-105 bg-background"
            >
              <CardHeader>
                  ...
                  <Card className="h-full bg-background/80 backdrop-blur-sm border-luxury-rose hover:shadow-luxury transition-all duration-300">
                    <CardContent className="p-6">
                      ...
                      <div className="relative mb-4">
                        ...
                        <p className="text-luxury-charcoal leading-relaxed pl-4">{review.review}</p>
                      </div>
